...
public class CargaImagen {
    ...
    /**
     * Carga una imagen en una matriz. La imagen es convertida automáticamente a una
     * escala de niveles de grises [0-255].
     * 
     ...
     * 
     * @param matriz  Cada celda de la matriz representa un pixel de la imagen,
     *                codificado en 256 niveles de grises [0-255].
