...
public class EjemploRMI1 extends UnicastRemoteObject // el servidor debe siempre extender esta clase
								...
								// remota definida con caracter previo
{
	public int Suma(int x, int y) throws RemoteException {
		System.out.println("Recibido " + x + " y " + y);
		return x + y;
	}
	...
	public EjemploRMI1() throws RemoteException {// super(); invoca automaticamente al constructor de la superclase
	}
