 ...
 * ESPECIFICACIONES: el programa ilustra el uso de los m�todos  
 * necesarios para medir el tiempo de ejecuci�n de un programa o de  
...
public class medTemporal {
  ...
  public static void main(String[] args) {
    ...
    Arrays.sort(datos); // se ordena el array de n�meros
    long finCronom = System.currentTimeMillis(); // se para el cronometro
    d.setTime(finCronom);
    System.out
        .println("Acabando trabajo a las " + df.format(d) + " tras " + (finCronom - inicCronom) + " milisegundos");
    s.close();
  }// main
}// medTemporal
